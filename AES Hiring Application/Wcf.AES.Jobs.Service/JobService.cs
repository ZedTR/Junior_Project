    ...
    public class JobService : IJobService
    {
        ...
        { 
            using (db)
            {
                ...
                var qList = db.QuestionLists.ToList().Select(x => new QuestionForm
                {
                    question = new Question(x.Id, x.Title, x.Question),
        ...
        public List<Question> getAllQuestions()
        {
            using (db)
            {
                IQueryable<Question> questionEntity = db.QuestionLists.Select(x => new Question
                {
                    QuestionID = x.Id,
